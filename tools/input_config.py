    ...
    return {
      'kvmd': {
        ...
        'hid':{'type':'otg','keymap':source+'/contrib/keymaps/en-us',
               ...
               'mouse_alt':{'device':''},'jiggler':{'enabled':False}},
      ...
      'otg':{'gadget':'rkmoon','udc':udc,'user':'root','meta':'/run/rkmoon-gadget/meta',
             'manufacturer':'RKMoon','product':'RKMoon keyboard and relative mouse',
             'serial':'RKMOON001','config':'RKMoon HID only','remote_wakeup':False,
             'devices':{'hid':{'keyboard':{'start':True},'mouse':{'start':True},'mouse_alt':{'start':False}},
